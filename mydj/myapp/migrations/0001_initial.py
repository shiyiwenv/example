# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-03-28 04:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=120, verbose_name='\u7ec4\u540d')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('keyPath', models.CharField(max_length=120, verbose_name='\u79c1\u94a5\u4fdd\u5b58\u8def\u5f84')),
                ('password', models.CharField(blank=True, max_length=120, null=True, verbose_name='\u79c1\u94a5\u5bc6\u7801')),
                ('createTime', models.DateTimeField(auto_now_add=True, verbose_name='\u521b\u5efa\u65f6\u95f4')),
                ('changeTime', models.DateTimeField(auto_now=True, verbose_name='\u4fee\u6539\u65f6\u95f4')),
                ('ChangeUser', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='KeyChangeUser', to=settings.AUTH_USER_MODEL)),
                ('createUser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='KeyCreateUser', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': '\u670d\u52a1key',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=120, verbose_name='\u9879\u76ee\u540d')),
                ('gitAddress', models.CharField(max_length=120, verbose_name='\u6570\u636e\u6e90')),
                ('gitVersion', models.CharField(blank=True, max_length=50, null=True, verbose_name='\u4ed3\u5e93\u7248\u672c')),
                ('defaultBranch', models.CharField(blank=True, max_length=120, null=True, verbose_name='\u9ed8\u8ba4\u5206\u652f')),
                ('preScriptPath', models.CharField(max_length=120, verbose_name='\u9884\u5904\u7406\u811a\u672c')),
                ('pushPath', models.CharField(max_length=120, verbose_name='\u63a8\u9001\u901a\u77e5')),
                ('excludeList', models.TextField(verbose_name='\u6392\u9664\u5217\u8868')),
                ('serverPort', models.IntegerField(verbose_name='\u670d\u52a1\u5668\u7aef\u53e3')),
                ('postScriptPath', models.CharField(max_length=120, verbose_name='\u66f4\u65b0\u540e\u811a\u672c\u5730\u5740')),
                ('threadNum', models.IntegerField(default=1, verbose_name='\u7ebf\u7a0b\u6570')),
                ('sync', models.BooleanField(default=False, verbose_name='\u5b8c\u5168\u540c\u6b65')),
                ('createTime', models.DateTimeField(auto_now_add=True, verbose_name='\u521b\u5efa\u65f6\u95f4')),
                ('changeTime', models.DateTimeField(auto_now=True, verbose_name='\u4fee\u6539\u65f6\u95f4')),
                ('isTemplate', models.BooleanField(default=False, verbose_name='\u662f\u5426\u4e3a\u9879\u76ee\u6a21\u677f')),
                ('backupPath', models.CharField(blank=True, max_length=120, null=True, verbose_name='\u5907\u4efd\u8def\u5f84')),
                ('changeUser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ProjectChangeUser', to=settings.AUTH_USER_MODEL)),
                ('createUser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ProjectCreateUser', to=settings.AUTH_USER_MODEL)),
                ('dstServerKey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.Key')),
            ],
            options={
                'verbose_name': '\u9879\u76ee\u8868',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=20, verbose_name='\u72b6\u6001\u540d')),
            ],
            options={
                'verbose_name': '\u516c\u5171\u72b6\u6001\u8868',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('log', models.TextField(verbose_name='\u7cfb\u7edf\u65e5\u5fd7\u4fe1\u606f')),
                ('createTime', models.DateTimeField(auto_now_add=True, verbose_name='\u521b\u5efa\u65f6\u95f4')),
                ('changeTime', models.DateTimeField(auto_now=True, verbose_name='\u5199\u5165\u65f6\u95f4')),
            ],
            options={
                'verbose_name': '\u7cfb\u7edf\u65e5\u5fd7',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('log', models.TextField(verbose_name='\u4efb\u52a1\u6267\u884c\u65e5\u5fd7')),
                ('createTime', models.DateTimeField(auto_now_add=True, verbose_name='\u521b\u5efa\u65f6\u95f4')),
                ('execUser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('ip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.Service')),
        ...
        migrations.AddField(
            model_name='project',
            name='middleServer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='middleServer', to='myapp.Service'),
        ),
        migrations.AddField(
            model_name='project',
            name='postServer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='postServer', to='myapp.Service'),
        ),
        migrations.AddField(
            model_name='project',
            name='preServer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='preServer', to='myapp.Service'),
        ),
        migrations.AddField(
            model_name='project',
            name='status',
